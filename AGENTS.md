...
- Start with `README.md`. For client work, read `CLIENT-AI-GUIDE.md`, `STARTER-PROMPTS.md`, and `prompt-library/README.md`. For continuation work, read `PICK-UP-HERE.md`, `CURRICULUM-AUDIT.md`, `TORQ-LEARNING-STRUCTURE.md`, and the selected program's `BUILD-HANDOFF.md` before opening detailed source files.
